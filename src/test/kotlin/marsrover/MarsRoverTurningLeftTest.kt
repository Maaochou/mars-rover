...
class MarsRoverTurningLeftTest {

    val moveRover: MoveRover = RoverMover()

    @Test
    fun mars_rover_facing_north_should_go_turn_left() {
        // Given
        val marsRover = MarsRover(5, 5, RoverDirection.N);
        // When
        val resultingMarsRover = moveRover.move(marsRover, RoverCommand.TL)
        // Then
    ...
    @Test
    fun mars_rover_facing_south_should_turn_left() {
        // Given
    ...
    @Test
    fun mars_rover_facing_east_should_turn_left() {
        // Given
    ...
    @Test
    fun mars_rover_facing_west_should_turn_left() {
        // Given
